package com.example.finalproject.activity.fragment;
...
import com.example.finalproject.activity.controler.MessageRecyclerAdapter;
...
public class MessageFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        messageList.add(new Message("blablabla", "blablabla"));
        messageList.add(new Message("blablabla", "blablabla"));
        messageList.add(new Message("blablabla", "blablabla"));
        messageList.add(new Message("blablabla", "blablabla"));
        messageList.add(new Message("blablabla", "blablabla"));
        ...
        messageRecycler.setAdapter(new MessageRecyclerAdapter(messageList));
